...
# if longer than 20, we can't train
# but we evaluate up to lenght 30
...
def get_fn_dataset(dataname, mode, direction="en-fr", data_path="data"):
    if dataname == "FLORES":
        ...
        #fn = f"{data_dir}/MTNT/{mode}/{direction}.tsv"
        Dataset = MTNTdataset

    elif "MED" in dataname:
        #fn = f"{data_dir}/MED/{mode}/{direction}.tsv"
        Dataset = MEDdataset

    elif "TED" in dataname:
        ...
        if target == "en":
            ...
            direction = direction
        Dataset = TEDdataset
    elif "EPARL" in dataname:
        Dataset = EPARLdataset
        
        #fn = f"{data_dir}/TED/{mode}/{direction}.tsv"
        #import pdb; pdb.set_trace() 
        #data_path.format(dataname, mode, direction)
    elif "TED" in dataname:
        Dataset = TEDdataset
    else:
...
class CollateFn:
    ...
    def __call__(self, batch):
        ...
        #prefix_compress = [b['prefix_compress'] for b in batch]
        ...
        #prefix_compress_ids, _ = self.get_encoding_length(prefix_compress)
        ...
        return {"ids":ids, 
                ...
                #
                #"prefix_compress": prefix_compress,
                #"prefix_compress_ids": prefix_compress_ids,
                #
                "targets": targets,
