...
from code.explore import prompts_stats # , attn_sum, logits #, layer_inspect
...
def run(args, cfp):
    ...
    if args.do_analysis:
        ...
        print("finished analysis.. terminating program")
        sys.exit(0)


    all_gen_text = utils.gen_text(args.hf_decode_configs,
                                  args.format,
                                  model,
                                  tokenizer,
                                  dataloader,
...
if __name__ == "__main__":
    ...
    argparser.add_argument('--do_analysis', action="store_true")
